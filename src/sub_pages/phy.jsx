...
import { ArrowLeft, ChevronRight, FileText, Ruler , Zap , Thermometer  } from 'lucide-react';
  ...
  const resources = [
    {
      ...
      content : "This chapter deals with the basic units of measurement and their conversion. It also deals with the errors in measurement and the significant figures.",
      icon: Ruler 
    },
    {
      title: "Electricity , Magnetism and Semiconductors",
      pdfPath: "pdf_resources/physics/UnitIIIThermometry&Fiberoptics.pdf",
      content : "This chapter is about the basic concepts of electricity and magnetism. It also deals with the semiconductors and their applications.",
      icon: Zap 
    },
    {
      title: "Thermometry and Fibre Optics",
      pdfPath: "pdf_resources/physics/UnitIIIThermometry&Fiberoptics.pdf",
      content : "This chapter deals with the basic concepts of thermometry and fibre optics. It also deals with the applications of fibre optics.",
      icon: Thermometer 
    }
  ];
